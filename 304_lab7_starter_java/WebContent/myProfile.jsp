...
<%
    ...
    out.println("<div class='container pt-2 mb-2 d-flex justify-content-center' style='text-align: center; height: 150px;'>");
        out.println("<div class='card'>");
            ...
            out.println("<div class='row pr-4 mt-2'>");
                out.println("<div class='col'>");
                    out.println("<h5 style='text-justify: inter-word;'>Users</h5>");
                out.println("</div>");
                out.println("<div class='col'>");
                    out.println("<h5>Total Users/Fees</h5>");
                out.println("</div>");
            out.println("</div>");
            out.println("<div class='row pr-4'>");
                out.println("<div class='col'>");
                    out.println("<a href='./showUsers.jsp' class='btn btn-primary' style='border-radius: 30px; height: 60px; width: 60px; background: url(Avatars/1.png); background-position:center; background-size: contain;'></a>");
                out.println("</div>");
                out.println("<div class='col'>");
                    out.println("<a href='./showUsers$.jsp' class='btn btn-primary' style='border-radius: 30px; height: 60px; width: 60px; background: url(Avatars/8.png); background-position:center; background-size: contain;'></a>");
                out.println("</div>");
            out.println("</div>");
        out.println("</div>");
    out.println("</div>");
